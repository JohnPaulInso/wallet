            ...
            for (const srcAcc of sourceAccounts) {
                try {
                    ...
                    for (const srcDoc of srcSnap.docs) {
                        ...
                        // Stable ID: prefix with source account to avoid collision
                        const dupId = `atome_auto_${srcAcc}_${srcDoc.id}`;
                        ...
                        // (2026-07-13) Set duplicated Atome payments to Income; prev: Credit Card Payment
                        const dupTxn = {
                            ...srcData,
                            id: dupId,
